...
inputs = [
    ...
    ("vessel", "FILE", "Vessel scan image file"),
    ("exe", "PATH", "Path to Niftypipe python script perform_vessels2gad_registration.py"),
    ("omp", "STRING", "number of core use by reg_aladin", "f"),
    ("working_dir", "PATH", "working directory for temp files", "f")]

outputs = [
    ("*_res.nii.gz", "FILE", "OUTPUT"),
    ("*.txt", "FILE", "TRANS"),
    ("vessels2gad.pdf", "FILE", "PDF")
]
