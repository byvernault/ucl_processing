...
inputs = [
    ("t1", "FILE", "T1 image file path"),
    ("matlab_code", "PATH", "Path containing the matlab code for Sample GM Segment."),
...
outputs = [
    ...
    ("*.mat", "FILE", "MAT"),
    ("rc*.nii.gz", "FILE", "RC"),
    ("sample_gm_report.pdf", "FILE", "PDF")
]

code = r"""%% Matlab Code for AutoSpider for Sample GM Segment using SPM
