"""Processor associated to Spider_Stretched_Maps.
...
ucl_spiders/', 'Spider_Stretched_Maps_v1_0_0.py')
DEFAULT_WALLTIME = '14:00:00'
DEFAULT_MEM = 8048
...
class Processor_Stretched_Maps(ScanProcessor):
    ...
    def __init__(self, spider_path=DEFAULT_SPIDER_PATH, version=None,
        ...
        super(Processor_Stretched_Maps,
